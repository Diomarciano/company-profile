    ...
    <main className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-br from-blue-950 to-blue-900 text-white py-16 px-6">
        <div className="max-w-4xl mx-auto">
          <Link href="/#layanan" className="text-blue-300 text-sm hover:text-white transition-colors mb-4 inline-block">
            ← Kembali ke Layanan
          </Link>
          <h1 className="text-3xl md:text-4xl font-bold mt-2">{product.name}</h1>
          {product.price && (
            <span className="inline-block mt-4 bg-white/10 text-white text-sm px-4 py-1.5 rounded-full">
              {product.price}
            </span>
          )}
        </div>
